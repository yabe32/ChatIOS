...
async def get_user_settings_by_session_user(
    ...
    if user.role != 'admin':
        ...
        # Keep harmless personalization, but strip AI/backend control surfaces.
        for key in (
            'models',
            'params',
            'system',
...
async def update_user_settings_by_session_user(
    ...
    if user.role != 'admin':
        ...
        # Normal users may keep interface preferences, but cannot persist backend-control settings.
        for key in (
            'models',
            'params',
            'system',
